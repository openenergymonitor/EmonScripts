...
# -----------------------------------------------------------------
echo
current_settings_md5="$($usrdir/EmonScripts/update/./md5sum.py $emoncms_dir/settings.php)"
echo "current settings.php md5: $current_settings_md5"

current_default_settings_md5="$($usrdir/EmonScripts/update/md5sum.py $emoncms_dir/default.emonpi.settings.php)"
...
# -----------------------------------------------------------------
echo
new_default_settings_md5="$($usrdir/EmonScripts/update/md5sum.py $emoncms_dir/default.emonpi.settings.php)"
...
for service in "mqtt_input"; do
  $usrdir/EmonScripts/update/remove_emoncms_service.sh $service
done
